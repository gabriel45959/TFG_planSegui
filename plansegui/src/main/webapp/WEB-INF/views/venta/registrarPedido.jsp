	...
	<form:form method="post" modelAttribute="cargarPedido"
		...
		<script type="text/javascript">
								...
								$("#addrow")
										.on(
												...
												function() {
													...
													cols += '<td><form:select id="producto" path="detallePedido[0].producto.id" name="producto' + counter + '" class="form-control"><form:option value="0">Seleccione...</form:option><form:options items="${listaProducto}" itemValue="id" itemLabel="nombre"/></form:select></td>'
															.replace("[0]",
																	aux2);
													cols += '<td><form:input type="text" path="detallePedido[0].cantidad" class="form-control" name="cantidad' + counter + '"/></td>'
															.replace("[0]",
																	aux2);
			...
			function calculateGrandTotal() {
				var grandTotal = 0;
				$("table.order-list").find('input[name^="price"]').each(
						function() {
							grandTotal += +$(this).val();
						});
							...
							<div class="row align-items-center">
								<div class="col">
									<div class="form-group">
										...
										<form:select id="empresa" path="empresa.id" name="empresa"
											class="form-control">
											<form:option value="0">Seleccione...</form:option>
											<form:options items="${listaEmpresa}" itemValue="id"
												itemLabel="nombre" />
										</form:select>
								...
								<div class="col">
									<div class="form-group">
										...
										<form:input id="fechaEntrega" type="date" name="fechaEntrega"
											path="fechaEntrega" class="form-control" />
									</div>
								</div>
